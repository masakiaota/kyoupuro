// v011_middle_reroute_sa_score_prefix.rs
...
fn build_score_prefix(board: &Board, cells: &[usize]) -> Vec<i32> {
...
fn main() {
    ...
    let mut cur_score_pref = build_score_prefix(&board, &cur_cells);
    ...
    while global_start.elapsed().as_secs_f64() < TOTAL_TIME_LIMIT_SEC {
        ...
        let old_seg_score_delta: i32 = cur_score_pref[r] - cur_score_pref[l];
        let old_seg_len = r - l;
        ...
        cur_score_pref = build_score_prefix(&board, &cur_cells);
