...
fn main() {
    ...
    while global_start.elapsed().as_secs_f64() < TOTAL_TIME_LIMIT_SEC {
        ...
        let old_seg_score_delta: i32 = best_cells[l + 1..=r]
            .iter()
        ...
        let candidate_score_delta = best_score_delta - old_seg_score_delta + new_seg_score_delta;
        if !is_better(candidate_len, candidate_score_delta, len, best_score_delta) {
            continue;
        }
