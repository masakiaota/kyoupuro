// v034_early_complement_verify.rs
...
const VERIFY_COMPLEMENT_POSTERIOR_THRESHOLD: f64 = 0.85;
...
fn main() {
    ...
    eprintln!(
        "v034 mode={:?} target_size={} candidates={} m={} mi_cutoff={} mi_active_limit={} turn_pool_limit={} sa_temp={}->{} sa_proposals={}/{}K sa_seeds=min({}M,{}) sa_delta_eval=true shape_swap_alpha={} fixed_mi_sweeps={} verify_complement_threshold={} verify_complement_min_size={}",
        candidate_mode,
        target_size,
        ...
        VERIFY_COMPLEMENT_POSTERIOR_THRESHOLD,
    ...
    while turns_used < query_limit {
        ...
        if let Some((best_mask, best_prob)) = best {
            if best_prob >= VERIFY_COMPLEMENT_POSTERIOR_THRESHOLD
                && turns_used + 2 <= query_limit
                && !complement_verified_masks.contains(&best_mask)
            {
            ...
            eprintln!("v034 failed: no finite posterior candidates");
            return;
        }
