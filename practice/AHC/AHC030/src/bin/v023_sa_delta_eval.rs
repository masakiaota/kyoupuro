...
fn main() {
    ...
    eprintln!(
        "v023 mode={:?} target_size={} candidates={} m={} mi_cutoff={} mi_active_limit={} sa_temp={}->{} sa_proposals={}x sa_seeds=min({}M,{}) sa_delta_eval=true",
        candidate_mode,
        target_size,
    ...
    while turns_used < query_limit {
        ...
        if let Some((best_mask, best_prob)) = best {
            ...
            eprintln!("v023 failed: no finite posterior candidates");
            return;
        }
