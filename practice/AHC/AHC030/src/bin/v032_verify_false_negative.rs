...
fn main() {
    ...
    eprintln!(
        "v032 mode={:?} target_size={} candidates={} m={} mi_cutoff={} mi_active_limit={} turn_pool_limit={} sa_temp={}->{} sa_proposals={}/{}K sa_seeds=min({}M,{}) sa_delta_eval=true shape_swap_alpha={} fixed_mi_sweeps={} verify_complement_min_size={}",
        candidate_mode,
        target_size,
    ...
    while turns_used < query_limit {
        ...
        if let Some((best_mask, best_prob)) = best {
            ...
            eprintln!("v032 failed: no finite posterior candidates");
            return;
        }
