...
fn main() {
    ...
    eprintln!(
        "v021 mode={:?} target_size={} candidates={} m={} mi_cutoff={} mi_active_limit={} sa_temp={}->{} sa_proposals={}x",
        candidate_mode,
        target_size,
    ...
    while turns_used < query_limit {
        ...
        if let Some((best_mask, best_prob)) = best {
            ...
            eprintln!("v021 failed: no finite posterior candidates");
            return;
        }
