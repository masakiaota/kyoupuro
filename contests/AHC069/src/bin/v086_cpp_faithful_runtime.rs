// v086_cpp_faithful_runtime.rs
#![allow(non_snake_case)]
// 問題文の `N`, `M`, `S`, `T`, `P`, `V` を対応づけたまま使う。
// 中心アイデア: v081 の数理方策を保ち、提供 C++ と同じ探索仕事量・時間挙動になるよう、
// rough の方策時計起点、同点比較、反復 buffer と smooth の不要な clone を忠実化する。
...
struct Placement {
    ...
    /// 0: 既存候補、1: size/clearance 候補、2: box 侵食候補。
    strategy_tag: u8,
