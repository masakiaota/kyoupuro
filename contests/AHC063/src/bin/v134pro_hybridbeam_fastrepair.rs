// v134pro_hybridbeam_fastrepair.rs
// メモ:
...
fn repair_prefix_after_bite(
    ...
    let mut ops = String::with_capacity(need);
...
fn advance_with_restore_queue(
    ...
    dropped: &mut DroppedBuf,
) -> Option<(State, String, Option<usize>)> {
