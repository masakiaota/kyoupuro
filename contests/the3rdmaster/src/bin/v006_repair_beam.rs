...
const MAX_SCAN_CANDIDATES: usize = 96;
const MAX_TOP_OCCS: usize = 384;
const MAX_SEED_OCCS: usize = 16;
const MAX_VARIANTS_PER_CANDIDATE: usize = 20;
const MAX_BRANCHES_PER_STATE: usize = 48;
const MAX_BEAM_WIDTH: usize = 320;
const MAX_BEAM_DEPTH: usize = 24;
    ...
    for depth in 0..MAX_BEAM_DEPTH {
        ...
        for state in beam.into_iter() {
            ...
            for transition in transitions.into_iter().take(MAX_BRANCHES_PER_STATE) {
                ...
                let next_total_bound = next_cost + transition.next_residual_count;
                ...
                let seen_key = (
                    transition.next_residual,
                    next_loaded.map(|idx| idx as i16).unwrap_or(-1),
                );
                ...
                next.push(BeamState {
                    residual: transition.next_residual,
                    residual_count: transition.next_residual_count,
