...
const CASE_SORT_OPTIONS = [
  ...
  { key: "zero_dist_asc", label: "dist(0,exit) ∧" },
  { key: "zero_dist_desc", label: "dist(0,exit) ∨" },
  { key: "exit_value_asc", label: "exit_value ∧" },
  { key: "exit_value_desc", label: "exit_value ∨" },
];
...
function parseCaseMeta(filePath) {
  ...
  return {
    ...
    zeroI,
    zeroJ,
    zeroDist: zeroI >= 0 ? Math.abs(zeroI - exitI) + Math.abs(zeroJ - exitJ) : null,
    exitValue,
  };
}
