...
impl Solver {
        ...
        for j in 0..m {
            if sorted[j].attach_idx < path_edges_len {
                if layout_mode == 0 {
                    ...
                    // v906: keep S1..S9 as a compact goal-side inner gadget.
    ...
    fn solve_nested_chamber(&mut self, timer: &Timer, deadline: f64) -> (Solution, PermanentCorridorStats) {
        ...
        while timer.sec() < deadline {
            ...
            let Some(spine) = self.random_spine_backbone(total_depth, &mut rng, timer, deadline) else {
                continue;
            };
...
fn main() {
    ...
    #[cfg(feature = "local")]
    {
        ...
        eprintln!(
            "[v906] source=nested_chamber_full10_g19_final trials={} usable_paths={} decoder16_attempts={} decoder16_layout_ok={} decoder16_unreachable={} built={} max_path_len={} best_path_len={} best_t={} final_t={} doors={} switches={} ring_doors_lt18={} max_switch={} switch9_count={} door18_count={} door19_count={} best_pre_rewire_door19_count={} tooth_min={} tooth_avg_x100={} tooth_max={} tooth_lens={:?} s0_tooth={} leak_candidates={} press_count={} move_count={} avg_move_per_press_x100={}",
            direct_stats.trials,
        ...
        if switch9_count != 1 || max_switch != 9 || door18_count != 0 || press_count != 1023 {
            eprintln!("[v906.error] full10 chamber experiment should use all switches and press 1023 times");
        }
    }
