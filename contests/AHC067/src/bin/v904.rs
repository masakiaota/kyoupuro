        ...
        for j in 0..m {
            if sorted[j].attach_idx < path_edges_len {
                if layout_mode == 0 {
                    ...
                    // v904: keep S1..S9 as a compact goal-side inner gadget.
...
fn main() {
    ...
    #[cfg(feature = "local")]
    {
        ...
        eprintln!(
            "[v904] source=s0_s1_outer_inner_goal_cluster switch9_final=1 trials={} usable_paths={} decoder16_attempts={} decoder16_layout_ok={} decoder16_unreachable={} built={} max_path_len={} best_path_len={} best_t={} final_t={} doors={} switches={} ring_doors_lt18={} max_switch={} switch9_count={} door18_count={} door19_count={} best_pre_rewire_door19_count={} tooth_min={} tooth_avg_x100={} tooth_max={} tooth_lens={:?} s0_tooth={} leak_candidates={} press_count={} move_count={} avg_move_per_press_x100={}",
            direct_stats.trials,
        ...
        if switch9_count != 1 {
            eprintln!("[v904.error] switch kind 9 should be used exactly once as the final switch");
        }
    }
