    ...
    fn solve_decoder16_corridor(
        ...
        while timer.sec() < limit_sec {
            ...
            if let Some((sol, layout_stats)) =
                self.build_decoder16_corridor_solution(&vt, &path, 1, &mut stats)
            {
                stats.built += 1;
                if sol.t > best.t {
                    best = sol;
...
fn main() {
    ...
    best = solver.replace_unused_permanent_walls(&best, &timer, PRUNE_LIMIT_SEC);
    ...
    #[cfg(feature = "local")]
    {
        ...
        eprintln!(
            "[v901] source=decoder18_corridor switch9_final=1 trials={} usable_paths={} decoder16_attempts={} decoder16_layout_ok={} decoder16_unreachable={} built={} max_path_len={} best_path_len={} best_t={} final_t={} doors={} switches={} ring_doors_lt18={} max_switch={} switch9_count={} door18_count={} door19_count={} best_pre_rewire_door19_count={} tooth_min={} tooth_avg_x100={} tooth_max={} tooth_lens={:?} s0_tooth={} leak_candidates={} press_count={} move_count={} avg_move_per_press_x100={}",
            direct_stats.trials,
        ...
        if switch9_count != 1 {
            eprintln!("[v901.error] switch kind 9 should be used exactly once as the final switch");
        }
    }
